    ...
    <>
      ...
      <footer id="footer" className="w-full footer-root" style={{ background: "#111111" }}>
        ...
        <div className="px-6 pt-6 pb-6">
          <div
            className="flex flex-wrap items-center justify-center w-full gap-6 mx-auto rounded-2xl"
            style={{
              background: "#F97316",
          ...
          >
            <div className="text-center">
              <p className="font-extrabold leading-tight tracking-widest text-white"
                style={{ fontSize: "clamp(2.6rem, 4vw, 7rem)", fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.07em" }}>
        ...
        <div className="flex flex-wrap items-start justify-between gap-10 px-10 pt-8 pb-8">
          ...
          <div className="max-w-xs">
            ...
            {/* Brand */}
            <div className="flex text-3xl tracking-widest text-white font-bebas gap-1.5 mb-3 ">
          ...
          {/* Navbar Links */}
            ...
            <div className="flex flex-col gap-3">
                {[
                    ...
                    key={item.name}
                    href={item.link}
                    className="text-base transition-colors duration-200 f-link hover:text-white"
        ...
        <div className="px-10 py-4 text-white">
            <p style={{ color: "rgba(255,255,255,0.25)" }}>Design and developed by <a href="" className="text-white text-[16px] font-bold">Pala<span className="text-[#6B3FFF]">Sync</span></a></p>
        </div>
